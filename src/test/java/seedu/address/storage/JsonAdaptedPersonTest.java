...
public class JsonAdaptedPersonTest {
    ...
    @Test
    public void toModelType_invalidRemarks_throwsIllegalValueException() throws Exception {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, INVALID_REMARK);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
}
